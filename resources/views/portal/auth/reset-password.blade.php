...
<head>
    ...
    <title>Set New Password — {{ \App\Models\Setting::get('app_name', 'DFCP COMS') }}</title>
...
<div class="login-wrap">
    <div class="login-card">
        <div class="text-center mb-5">
            ...
            <div class="brand-name">Set a New Password</div>
        </div>
        ...
        <form method="POST" action="{{ route('portal.password.update') }}">
            ...
            <button type="submit" class="btn-login"><i class="bi bi-check-lg"></i>Reset Password</button>
        </form>
    </div>
</div>
</body>
