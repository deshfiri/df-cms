...
<head>
    ...
    <title>Client Login — {{ \App\Models\Setting::get('app_name', 'DFCP COMS') }}</title>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    [data-theme="dark"] .alert-danger { background: rgba(248,113,113,.1); color: #f87171; }
    ...
    .btn-login:hover { background: var(--primary-dark); box-shadow: 0 4px 12px rgba(var(--primary-rgb),.3); }
    ...
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('portal.login.submit') }}">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('portal.password.request') }}" class="form-check-label text-decoration-none" style="color:var(--primary)">Forgot password?</a>
            </div>
        ...
        <div class="login-footer">
            <i class="bi bi-shield-check"></i>Secured Client Access
        </div>
    </div>
</div>
