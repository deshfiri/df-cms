...
@section('content')
            ...
            <div class="d-flex align-items-start gap-3 flex-wrap">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="text-muted small mt-1">
                        ...
                        @endif
                        @if($client->page_link)
                            · <a href="{{ $client->page_link_url }}" target="_blank" class="text-muted"><i
                                    class="bi bi-facebook me-1"></i>Page</a>
                        @endif
                        @if($client->designs_link)
                            · <a href="{{ $client->designs_link_url }}" target="_blank" class="text-muted"><i
                                    class="bi bi-palette me-1"></i>Designs</a>
                        @endif
                        @if($client->category)
                            · <span
                                style="display:inline-block;padding:2px 8px;border-radius:20px;font-size:.68rem;font-weight:500;background:rgba(var(--primary-rgb),.1);color:var(--primary)">{{ $client->category->name }}</span>
                        @endif
                        · <i class="bi bi-calendar3 me-1"></i>{{ $client->joining_date?->format('d M Y') ?? '—' }}
                        · <i class="bi bi-person-check me-1"></i>Assigned to <span
                            id="assignedToName">{{ $client->assignedUser?->name ?? 'Unassigned' }}</span>
                    </div>
                    <div class="mt-2">
                ...
                <div class="d-flex gap-2 ms-auto">
                    ...
                    @can('transfer', $client)
                        <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#transferOwnerModal">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            @foreach(\App\Models\Client::$statuses as $s)
                                ...
                                <li>
                                    <button
                                        class="dropdown-item small btn-status {{ $s === $client->client_status ? 'active fw-semibold' : '' }} {{ $s === 'Terminated' ? 'text-danger' : '' }}"
    ...
    <ul class="nav nav-tabs mb-3" id="clientTabs">
        <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#tab-workflow"><i
                    class="bi bi-diagram-3 me-1"></i>Workflow</a></li>
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-product"><i
                    class="bi bi-box me-1"></i>Product Updates</a></li>
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-payments"><i
                    class="bi bi-credit-card me-1"></i>Payments</a></li>
        @can('viewAny', \App\Models\AdCampaign::class)
            <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-ads"><i
                        class="bi bi-megaphone me-1"></i>Ads</a></li>
        @endcan
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-docs"><i
                    class="bi bi-folder2 me-1"></i>Documents</a></li>
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-meetings" id="meetingsTabLink"><i
                    class="bi bi-calendar-event me-1"></i>Meetings</a></li>
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-notes"><i
                    class="bi bi-chat-left-text me-1"></i>Notes</a></li>
        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-activity"><i
                    class="bi bi-clock-history me-1"></i>Activity</a></li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade" id="tab-ads">
            <div class="card section-card">
                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                    <h6 class="fw-bold mb-0">Ad Campaigns</h6>
                    @can('create', \App\Models\AdCampaign::class)
                        <div class="d-flex align-items-center gap-2">
                            <button class="btn btn-sm btn-outline-secondary" id="manageBrandsBtn" data-bs-toggle="modal" data-bs-target="#manageBrandsModal">
                ...
                <div class="px-3 pt-3 d-flex align-items-center gap-2 flex-wrap" id="brandPills">
                    <button class="fpill active" data-brand-id="" id="brandPillAll">All</button>
                </div>
                <div class="card-body p-0">
                    <div id="adsList">
                        <div class="d-flex justify-content-center py-5">
            ...
            <div class="row g-3 mb-3" id="docStats">
                ...
                <div class="col-6 col-md-3">
                    <div class="card text-center py-3">
                        ...
                        <div style="font-size:.69rem;color:var(--text3);text-transform:uppercase;letter-spacing:.04em">
                            Storage Used</div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
        ...
        <div class="tab-pane fade" id="tab-meetings">
            <div class="card section-card">
                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                    ...
                    @can('manage-meetings')
                        <button class="btn btn-sm btn-primary" id="addMeetingBtn" data-bs-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="productRemarks" class="form-control" rows="3"
    ...
    <div class="modal fade" id="addCampaignModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header py-3">
                    <h6 class="modal-title fw-bold">New Ad Campaign</h6>
                    <button class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="campBrand" class="form-select">
                ...
                <div class="modal-footer py-2">
                    <button class="btn btn-sm btn-light" data-bs-dismiss="modal">Cancel</button>
                    <button id="saveCampaign" class="btn btn-sm btn-primary"><i class="bi bi-check me-1"></i>Save</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="manageBrandsModal" tabindex="-1">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header py-3">
                    <h6 class="modal-title fw-bold">Manage Brands</h6>
                    <button class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <div class="d-flex gap-2 mb-3">
                        <input type="text" id="newBrandName" class="form-control form-control-sm" placeholder="New brand name">
                        <button id="addBrandBtn" class="btn btn-sm btn-primary text-nowrap"><i class="bi bi-plus-lg"></i></button>
                    </div>
                    <div id="brandManageList" class="d-flex flex-column gap-2"></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body px-3 py-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="docTitle" class="form-control form-control-sm"
                                placeholder="e.g. Client Agreement v1">
                        </div>
                        <div class="col-12">
                            <label class="form-label">File <span class="text-danger">*</span></label>
                            <div id="docDropZone" class="border-2 border rounded-3 text-center py-4 px-3"
                                ...
                                <div style="font-size:.79rem;color:var(--text2);margin-top:6px">Drag & drop file here or
                                    <span style="color:var(--primary);font-weight:600">browse</span></div>
                                <div style="font-size:.7rem;color:var(--text3);margin-top:3px">PDF, Word, Excel, CSV,
                                    Images, ZIP · Max 20MB</div>
                            </div>
                            <input type="file" id="docFile" class="d-none"
                                accept=".pdf,.jpg,.jpeg,.png,.webp,.gif,.doc,.docx,.xlsx,.xls,.csv,.zip">
                            <div id="docFileInfo" class="mt-2 d-none">
                                <div class="d-flex align-items-center gap-2 p-2 rounded"
                                    ...
                                    <div class="flex-fill min-w-0">
                                        <div id="docFileName" class="text-truncate"
                                            style="font-size:.79rem;font-weight:500"></div>
                                        <div id="docFileSize" style="font-size:.68rem;color:var(--text3)"></div>
                                    </div>
                                    <button type="button" onclick="clearDocFile()" class="btn btn-sm p-0"
                                        style="color:var(--text3)"><i class="bi bi-x-circle"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Description</label>
                            <textarea id="docDesc" class="form-control form-control-sm" rows="2"
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                <label class="form-label">Tags <span style="font-size:.68rem;color:var(--text3)">(comma
                                        separated)</span></label>
                                <input type="text" id="docTags" class="form-control form-control-sm"
                                    placeholder="e.g. signed, final, v2">
                            </div>
                        </div>
                    </div>
                    <div id="docUploadProgress" class="mt-3 d-none">
                        <div class="d-flex align-items-center gap-2 mb-1">
                            ...
                            <span id="docProgressPct"
                                style="font-size:.73rem;color:var(--primary);margin-left:auto">0%</span>
                        </div>
    ...
    <div class="modal fade" id="addMeetingModal" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header py-2 px-3">
                    <h6 class="modal-title fw-bold" id="meetingModalTitle"><i class="bi bi-calendar-plus me-2"></i>Schedule
                        Meeting</h6>
                    <button class="btn-close btn-sm" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body px-3 py-3">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" id="meetingTitle" class="form-control form-control-sm"
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold small">Date & Time <span
                                    class="text-danger">*</span></label>
                            <input type="datetime-local" id="meetingDatetime" class="form-control form-control-sm"
                                step="300">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6" id="meetingLocationWrap">
                            ...
                            <input type="text" id="meetingLocation" class="form-control form-control-sm"
                                placeholder="Office, address…">
                        </div>
                        <div class="col-md-6 d-none" id="meetingLinkWrap">
                            <label class="form-label fw-semibold small">Join Link</label>
                            <div class="d-flex align-items-center gap-2 p-2 rounded"
                                style="background:var(--surface2);border:1px solid var(--border);font-size:.76rem;color:var(--text3);height:31px">
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="meetingAgenda" class="form-control form-control-sm" rows="3"
                                placeholder="What will be discussed?"></textarea>
                        </div>
                    </div>
                    <div id="meetingConflictWarn" class="mt-3 p-2 rounded d-none c-red"
                        style="background:var(--c-red-bg);border:1px solid var(--c-red-bg);font-size:.77rem"></div>
                </div>
                <div class="modal-footer py-2 px-3">
                    <button class="btn btn-sm btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-3 py-3">
                    ...
                    <textarea id="completeMeetingNotes" class="form-control form-control-sm" rows="4"
                        placeholder="Key outcomes, next steps, action items…"></textarea>
                </div>
                <div class="modal-footer py-2 px-3">
                    <button class="btn btn-sm btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
...
@push('styles')
    <style>
        ...
        .wf-step.wf-current .wf-dot-open {
...
@push('scripts')
    <script>
        ...
        function loadAds() {
            $.get(baseUrl + '/ads', { brand_id: activeBrandId }).done(function (r) {
                const data = r.data;
                if (!data.length) {
                    $('#adsList').html('<p class="text-muted text-center py-4 small">No ad campaigns yet.</p>');
                    return;
                }
                let html = '<div class="table-responsive"><table class="table table-sm align-middle mb-0" style="font-size:.83rem"><thead><tr><th>Name</th><th>Brand</th><th>Platform</th><th>Status</th><th>Assigned</th><th>Budget</th><th>Spend</th><th>ROAS</th><th></th></tr></thead><tbody>';
                const statusClr = { Active: 'success', Paused: 'warning', Completed: 'primary', Cancelled: 'danger' };
                data.forEach(c => {
                    html += `<tr>
                    <td>${c.name}</td>
                    <td>${c.brand_name || '—'}</td>
                    <td>${c.platform || '—'}</td>
                    <td><span class="badge bg-${statusClr[c.status] || 'secondary'}">${c.status}</span></td>
                    <td>${c.assigned_name || 'Unassigned'}</td>
                    <td>${c.budget ? '৳' + parseFloat(c.budget).toFixed(2) : '—'}</td>
                    <td>৳${parseFloat(c.total_spend).toFixed(2)}</td>
                    <td>${c.roas !== null ? c.roas : '—'}</td>
                    <td><a href="${baseUrl}/ads/${c.id}" class="btn btn-xs btn-outline-secondary"><i class="bi bi-eye"></i></a></td>
                </tr>`;
                });
                html += '</tbody></table></div>';
                $('#adsList').html(html);
        ...
        function loadBrands() {
            $.get(baseUrl + '/brands').done(function (r) {
                brandCache = r.data;

                $('.fpill[data-brand-id]:not(#brandPillAll)').remove();
                brandCache.forEach(function (b) {
                    $('<button>').addClass('fpill').attr('data-brand-id', b.id)
                        .html(b.name + ' <span class="fcnt">' + b.ad_campaigns_count + '</span>')
                        .insertAfter('#brandPillAll');
                });

                $('#campBrand').html('<option value="">No Brand / General</option>');
                brandCache.forEach(function (b) {
                    $('#campBrand').append($('<option>').val(b.id).text(b.name));
                });
        ...
        function renderBrandManageList() {
            if (!brandCache.length) {
                $('#brandManageList').html('<p class="text-muted small text-center mb-0">No brands yet.</p>');
                return;
            }
            let html = '';
            brandCache.forEach(function (b) {
                html += `<div class="d-flex align-items-center justify-content-between border rounded px-2 py-1" style="border-color:var(--border) !important">
                    <span class="small">${b.name} <span class="text-muted">(${b.ad_campaigns_count})</span></span>
                    <span>
                        <button class="btn btn-xs btn-outline-secondary rename-brand" data-id="${b.id}" data-name="${b.name}"><i class="bi bi-pencil"></i></button>
                        <button class="btn btn-xs btn-outline-danger delete-brand" data-id="${b.id}"><i class="bi bi-trash"></i></button>
                    </span>
                </div>`;
            });
            $('#brandManageList').html(html);
        }

        $(document).on('click', '.fpill[data-brand-id]', function () {
            activeBrandId = $(this).data('brand-id') || '';
            $('.fpill[data-brand-id]').removeClass('active');
        ...
        $('#addBrandBtn').on('click', function () {
            ...
            if (!name) return;
            $.post(baseUrl + '/brands', { name: name }).done(function () {
                $('#newBrandName').val('');
                loadBrands();
            }).fail(function (xhr) {
                Swal.fire('Error', xhr.responseJSON?.message || 'Could not create brand.', 'error');
            });
        });

        $(document).on('click', '.rename-brand', function () {
            const id = $(this).data('id');
            const currentName = $(this).data('name');
            Swal.fire({ title: 'Rename brand', input: 'text', inputValue: currentName, showCancelButton: true, confirmButtonText: 'Save' })
                .then(function (r) {
                    if (!r.isConfirmed || !r.value || !r.value.trim()) return;
                    $.ajax({ url: baseUrl + '/brands/' + id, type: 'PUT', data: { name: r.value.trim() } })
                        .done(function () { loadBrands(); loadAds(); })
                        .fail(function (xhr) { Swal.fire('Error', xhr.responseJSON?.message || 'Could not rename brand.', 'error'); });
                });
        });

        $(document).on('click', '.delete-brand', function () {
            const id = $(this).data('id');
            Swal.fire({ title: 'Delete this brand?', text: 'Campaigns under it move back to General.', icon: 'warning', showCancelButton: true, confirmButtonColor: '#dc3545' })
                .then(function (r) {
                    if (!r.isConfirmed) return;
                    $.ajax({ url: baseUrl + '/brands/' + id, type: 'DELETE' }).done(function () {
                        if (activeBrandId == id) activeBrandId = '';
                        loadBrands();
                        loadAds();
                    });
                });
        ...
        $('#saveCampaign').on('click', function () {
            $.post(baseUrl + '/ads', {
                ...
                bootstrap.Modal.getInstance('#addCampaignModal').hide();
                loadAds();
                Swal.fire({ icon: 'success', title: 'Saved', timer: 1200, showConfirmButton: false });
            }).fail(function (xhr) {
                Swal.fire('Error', xhr.responseJSON?.message || 'Could not save campaign.', 'error');
            });
        });
        ...
        $('a[data-bs-toggle="tab"]').on('shown.bs.tab', function (e) {
            ...
            if (target === '#tab-ads') { loadBrands(); loadAds(); }
