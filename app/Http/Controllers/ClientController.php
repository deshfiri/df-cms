...
class ClientController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $statusCounts = Client::whereNull('deleted_at')
    ...
    private function dataTable(Request $request): JsonResponse
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('actions', fn ($c) => $this->actionButtons($c))
    ...
    private function actionButtons(Client $client): string
    {
        return '<div class="d-flex gap-1 justify-content-end row-acts">'
             ...
             . '<a href="' . route('clients.edit', $client) . '" class="btn btn-sm px-2 py-1" style="background:var(--surface2);border:1px solid var(--border);color:var(--text2)" title="Edit"><i class="bi bi-pencil"></i></a>'
             . '<button class="btn btn-sm px-2 py-1 btn-delete" data-id="' . $client->id . '" style="background:rgba(239,68,68,.08);border:1px solid rgba(239,68,68,.2);color:#dc2626" title="Delete"><i class="bi bi-trash"></i></button>'
             . '</div>';
    }
}
