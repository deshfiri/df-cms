    ...
    */
    ...
    'connections' => [
        ...
        'reverb' => [
            ...
            'options' => [
                // REVERB_HOST is the address browsers dial for websockets, so on a LAN
                // deployment it is the host machine's IP. Server-side event pushes stay
                // on loopback instead of routing back out through the network.
